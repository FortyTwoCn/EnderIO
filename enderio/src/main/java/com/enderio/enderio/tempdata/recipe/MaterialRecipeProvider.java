package com.enderio.enderio.tempdata.recipe;
...
public class MaterialRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, EIOItems.PHOTOVOLTAIC_COMPOSITE.get())
                .requires(CommonTags.Items.DUSTS_LAPIS)
                .requires(CommonTags.Items.DUSTS_COAL)
                .requires(EnderIOTags.Items.SILICON)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EIOItems.INFINITY_ROD.get())
                ...
                .pattern("NSN")
                .pattern("GN ")
                .define('N', EnderIOTags.Items.NUGGETS_DARK_STEEL)
                .define('G', EnderIOTags.Items.DUSTS_GRAINS_OF_INFINITY)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, EIOItems.SOUL_VIAL.get())
                ...
                .pattern("Q Q")
                .pattern(" Q ")
                .define('S', EnderIOTags.Items.INGOTS_SOULARIUM)
                .define('Q', EnderIOTags.Items.FUSED_QUARTZ)
                .unlockedBy("has_ingredient",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EIOItems.REDSTONE_FILTER_BASE)
                ...
                .pattern("PIP")
                .pattern("RPR")
                .define('R', EnderIOTags.Items.INGOTS_REDSTONE_ALLOY)
    ...
    private void addCapacitors(RecipeOutput recipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EIOItems.DOUBLE_LAYER_CAPACITOR.get())
                ...
                .pattern("CDC")
                .pattern(" I ")
                .define('I', EnderIOTags.Items.INGOTS_ENERGETIC_ALLOY)
                .define('C', EIOItems.BASIC_CAPACITOR.get())
                .define('D', CommonTags.Items.DUSTS_COAL)
                .unlockedBy("has_ingredient",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EIOItems.OCTADIC_CAPACITOR.get())
                ...
                .pattern("CGC")
                .pattern(" I ")
                .define('I', EnderIOTags.Items.INGOTS_VIBRANT_ALLOY)
    ...
    private void addCrystals(RecipeOutput recipeOutput) {
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EIOItems.PULSATING_CRYSTAL.get())
                ...
                .pattern("PDP")
                .pattern("PPP")
                .define('P', EnderIOTags.Items.NUGGETS_PULSATING_ALLOY)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EIOItems.VIBRANT_CRYSTAL.get())
                ...
                .pattern("PDP")
                .pattern("PPP")
                .define('P', EnderIOTags.Items.NUGGETS_VIBRANT_ALLOY)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EIOItems.WEATHER_CRYSTAL.get())
                ...
                .pattern("VEV")
                .pattern(" P ")
                .define('P', EnderIOTags.Items.GEMS_PULSATING_CRYSTAL)
                .define('V', EnderIOTags.Items.GEMS_VIBRANT_CRYSTAL)
                .define('E', EnderIOTags.Items.GEMS_ENDER_CRYSTAL)
                .unlockedBy("has_ingredient",
    ...
    private void addGears(RecipeOutput recipeOutput) {
        ...
        upgradeGear(recipeOutput, EIOItems.GEAR_ENERGIZED.get(), EnderIOTags.Items.GEARS_IRON,
                EIOItems.ENERGETIC_ALLOY_INGOT.get(), EIOItems.ENERGETIC_ALLOY_NUGGET.get());
        upgradeGear(recipeOutput, EIOItems.GEAR_VIBRANT.get(), EnderIOTags.Items.GEARS_ENERGIZED,
                EIOItems.VIBRANT_ALLOY_INGOT.get(), EIOItems.VIBRANT_ALLOY_NUGGET.get());
        upgradeGear(recipeOutput, EIOItems.GEAR_DARK_STEEL.get(), EnderIOTags.Items.GEARS_IRON,
                EIOItems.DARK_STEEL_INGOT.get(), EIOItems.DARK_STEEL_NUGGET.get());
    }

    private void addGrindingBalls(RecipeOutput recipeOutput) {
        grindingBall(recipeOutput, EIOItems.DARK_STEEL_BALL.get(), EnderIOTags.Items.INGOTS_DARK_STEEL,
                EIOItems.DARK_STEEL_INGOT.get());
        grindingBall(recipeOutput, EIOItems.SOULARIUM_BALL.get(), EnderIOTags.Items.INGOTS_SOULARIUM,
                EIOItems.SOULARIUM_INGOT.get());
        grindingBall(recipeOutput, EIOItems.CONDUCTIVE_ALLOY_BALL.get(), EnderIOTags.Items.INGOTS_CONDUCTIVE_ALLOY,
                EIOItems.CONDUCTIVE_ALLOY_INGOT.get());
        grindingBall(recipeOutput, EIOItems.PULSATING_ALLOY_BALL.get(), EnderIOTags.Items.INGOTS_PULSATING_ALLOY,
                EIOItems.PULSATING_ALLOY_INGOT.get());
        grindingBall(recipeOutput, EIOItems.REDSTONE_ALLOY_BALL.get(), EnderIOTags.Items.INGOTS_REDSTONE_ALLOY,
                EIOItems.REDSTONE_ALLOY_INGOT.get());
        grindingBall(recipeOutput, EIOItems.ENERGETIC_ALLOY_BALL.get(), EnderIOTags.Items.INGOTS_ENERGETIC_ALLOY,
                EIOItems.ENERGETIC_ALLOY_INGOT.get());
        grindingBall(recipeOutput, EIOItems.VIBRANT_ALLOY_BALL.get(), EnderIOTags.Items.INGOTS_VIBRANT_ALLOY,
                EIOItems.VIBRANT_ALLOY_INGOT.get());
        grindingBall(recipeOutput, EIOItems.COPPER_ALLOY_BALL.get(), EnderIOTags.Items.INGOTS_COPPER_ALLOY,
                EIOItems.COPPER_ALLOY_INGOT.get());
        grindingBall(recipeOutput, EIOItems.END_STEEL_BALL.get(), EnderIOTags.Items.INGOTS_END_STEEL,
