package com.enderio.enderio.client.core_to_sort.gui.widgets;
...
public class ToggleIconButton extends EnderButton {
    ...
    private static final ResourceLocation CHECKMARK = ResourceLocation.fromNamespaceAndPath(EnderIO.MOD_ID,
            "icon/checkmark");
