...
public class ConduitShape {
    ...
    private void updateShapeForConduit(ConduitBundle conduitBundle, Holder<Conduit<?, ?>> conduit) {
        ...
        Direction.Axis axis = ConduitSorter.OffsetHelper.findMainAxis(conduitBundle);
        ...
        for (Direction direction : Direction.values()) {
            ...
            if (connectedTypes.contains(conduit)) {
                Vec3i offset = ConduitSorter.OffsetHelper.translationFor(direction.getAxis(),
                        ConduitSorter.OffsetHelper.offsetConduit(connectedTypes.indexOf(conduit), connectedTypes.size()));
        ...
        if (box != null) {
            if (notRendered != null) {
                Vec3i offset = ConduitSorter.OffsetHelper.translationFor(axis, ConduitSorter.OffsetHelper.offsetConduit(i, allConduits.size()));
