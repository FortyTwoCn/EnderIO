package com.enderio.enderio.common.content.machines.blocks.alloy;
...
import com.enderio.enderio.common.content.machines.base.inventory.MultiSlotAccess;
import com.enderio.enderio.common.content.machines.base.inventory.SingleSlotAccess;
import com.enderio.enderio.common.content.machines.base.task.PoweredCraftingMachineTask;
import com.enderio.enderio.common.content.machines.base.task.host.CraftingMachineTaskHost;
...
public class AlloySmelterBlockEntity extends PoweredMachineBlockEntity {
    ...
    protected static class AlloySmeltingMachineTask
        ...
        public void deserializeNBT(HolderLookup.Provider lookupProvider, CompoundTag nbt) {
            ...
            inputsConsumed = nbt.getInt(EIONBTKeys.PROCESSED_INPUTS);
        }

        @Override
        public CompoundTag serializeNBT(HolderLookup.Provider lookupProvider) {
            var tag = super.serializeNBT(lookupProvider);
            tag.putInt(EIONBTKeys.PROCESSED_INPUTS, inputsConsumed);
            return tag;
        }
    }
    ...
    public void saveAdditional(CompoundTag pTag, HolderLookup.Provider lookupProvider) {
        ...
        pTag.putInt(EIONBTKeys.MACHINE_MODE, this.mode.ordinal());
    ...
    public void loadAdditional(CompoundTag pTag, HolderLookup.Provider lookupProvider) {
        ...
        try {
            mode = AlloySmelterMode.values()[pTag.getInt(EIONBTKeys.MACHINE_MODE)];
    ...
    public void removeComponentsFromTag(CompoundTag tag) {
        ...
        tag.remove(EIONBTKeys.MACHINE_MODE);
    }
