package com.enderio.enderio.common.content.machines.blocks.drain;
...
public class DrainBlockEntity extends PoweredMachineBlockEntity implements RangedActor, FluidTankUser {
    ...
    public void loadAdditional(CompoundTag pTag, HolderLookup.Provider lookupProvider) {
        ...
        } else if (pTag.contains(EIONBTKeys.ACTION_RANGE)) {
            actionRange = ActionRange.parse(lookupProvider,
                    Objects.requireNonNull(pTag.get(EIONBTKeys.ACTION_RANGE)));
        } else {
