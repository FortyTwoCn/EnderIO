package com.enderio.enderio.common.content.machines.blocks.enchanter;
...
import com.enderio.legacy_layout.machines.common.io.DumbIOConfigurable;
...
public class EnchanterBlockEntity extends EnderBlockEntity implements MenuProvider {
    ...
    public void loadAdditional(CompoundTag tag, HolderLookup.Provider lookupProvider) {
        ...
        inventory.deserializeNBT(lookupProvider, tag.getCompound(EIONBTKeys.ITEMS));
    }

    @Override
    protected void saveAdditional(CompoundTag tag, HolderLookup.Provider lookupProvider) {
        super.saveAdditional(tag, lookupProvider);
        tag.put(EIONBTKeys.ITEMS, inventory.serializeNBT(lookupProvider));
    }
