package com.enderio.enderio.common.content.machines.blocks.stirling_generator;
...
public class StirlingGeneratorBlockEntity extends PoweredMachineBlockEntity {
    ...
    public void loadAdditional(CompoundTag pTag, HolderLookup.Provider lookupProvider) {
        ...
        if (pTag.contains(EIONBTKeys.BURN_TIME, CompoundTag.TAG_INT)) {
            burnTime = pTag.getInt(EIONBTKeys.BURN_TIME);
        }

        if (pTag.contains(EIONBTKeys.BURN_DURATION, CompoundTag.TAG_INT)) {
            burnDuration = pTag.getInt(EIONBTKeys.BURN_DURATION);
        }
    ...
    public void saveAdditional(CompoundTag pTag, HolderLookup.Provider lookupProvider) {
        ...
        pTag.putInt(EIONBTKeys.BURN_TIME, burnTime);
        pTag.putInt(EIONBTKeys.BURN_DURATION, burnDuration);
    }
