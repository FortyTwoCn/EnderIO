package com.enderio.enderio.common.legacy_to_move.integrations.jei.subtype;
...
public class SoulBindableSubtypeInterpreter implements ISubtypeInterpreter<ItemStack> {
    ...
    public @Nullable Object getSubtypeData(ItemStack ingredient, UidContext context) {
        var soulBindable = ingredient.getCapability(EnderIOCapabilities.SoulBindable.ITEM);
