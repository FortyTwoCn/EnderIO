...
import com.enderio.legacy_layout.base.common.loot.BrokenSpawnerLootModifier;
import com.enderio.legacy_layout.base.common.loot.SetLootCapacitorFunction;
import com.enderio.enderio.common.content.decoration.paint.CopyPaintFunction;
...
public class EIOLootModifiers {
    private static final DeferredRegister<MapCodec<? extends IGlobalLootModifier>> SERIALIZERS = DeferredRegister
            .create(NeoForgeRegistries.GLOBAL_LOOT_MODIFIER_SERIALIZERS, EnderIOAPI.NAMESPACE);

    private static final DeferredRegister<LootItemConditionType> CONDITIONS = DeferredRegister
            .create(Registries.LOOT_CONDITION_TYPE, EnderIOAPI.NAMESPACE);
    private static final DeferredRegister<LootItemFunctionType<?>> FUNCTIONS = DeferredRegister
            .create(Registries.LOOT_FUNCTION_TYPE, EnderIOAPI.NAMESPACE);
