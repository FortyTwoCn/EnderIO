...
import com.enderio.enderio.common.foundation.network.menu.ClientboundSyncSlotDataPacket;
import com.enderio.enderio.common.foundation.network.menu.ClientboundSyncSlotDataPacket.PayloadPair;
import com.enderio.enderio.common.foundation.network.menu.ContainerSyncData;
...
import com.enderio.enderio.common.foundation.network.menu.SyncSlot.ChangeType;
...
public abstract class BaseEnderMenu extends AbstractContainerMenu {
    ...
    protected void updateSlot(SyncSlot syncSlot) {
        ...
        if (playerInventory.player instanceof LocalPlayer) {
            ...
            SyncSlot.ChangeType changeType = syncSlot.detectChanges();
    ...
    public void broadcastChanges() {
        ...
        if (playerInventory.player instanceof ServerPlayer player) {
            List<ClientboundSyncSlotDataPacket.PayloadPair> payloads = new ArrayList<>();
            ...
            for (short i = 0; i < syncSlots.size(); i++) {
                ...
                if (changeType != ChangeType.NONE) {
                    ...
                    payloads.add(new ClientboundSyncSlotDataPacket.PayloadPair(i, payload));
                }
            }
