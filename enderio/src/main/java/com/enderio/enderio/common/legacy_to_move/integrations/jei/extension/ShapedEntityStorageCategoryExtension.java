package com.enderio.enderio.common.legacy_to_move.integrations.jei.extension;
...
import com.enderio.enderio.common.legacy_to_move.integrations.jei.EnderIOJEI;
...
public class ShapedEntityStorageCategoryExtension implements ICraftingCategoryExtension<ShapedEntityStorageRecipe> {
    ...
    public void setRecipe(RecipeHolder<ShapedEntityStorageRecipe> recipeHolder, IRecipeLayoutBuilder builder,
        ...
        if (input.isPresent()) {
            ...
            var outputSoulBindable = itemStack.getCapability(EnderIOCapabilities.SoulBindable.ITEM);
        ...
        if (noData) {
            var capturableEntityTypes = SoulCaptureUtil.getCapturableEntityTypes();
