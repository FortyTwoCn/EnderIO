...
public class VanillaCompat {
    ...
    public static void registerCapabilities(RegisterCapabilitiesEvent event) {
        for (var spawnEgg : SpawnEggItem.eggs()) {
            event.registerItem(EnderIOCapabilities.SoulBindable.ITEM, SPAWN_EGG_BINDABLE_PROVIDER, spawnEgg);
            event.registerItem(EnderIOCapabilities.SoulHandler.ITEM, SPAWN_EGG_HANDLER_PROVIDER, spawnEgg);
        }
    }
}
