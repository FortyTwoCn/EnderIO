...
import com.enderio.enderio.common.content.machines.blocks.obelisks.weather.WeatherChangeRecipe;
...
public class WeatherChangeCategory extends MachineRecipeCategory<RecipeHolder<WeatherChangeRecipe>> {
    ...
    public static final RecipeType<RecipeHolder<WeatherChangeRecipe>> TYPE = JEIUtils.createRecipeType(EnderIOAPI.NAMESPACE, "weather_change",
