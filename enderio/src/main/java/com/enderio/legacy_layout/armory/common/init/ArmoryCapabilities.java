...
import com.enderio.legacy_layout.armory.common.capability.DarkSteelEnergyStorage;
...
public class ArmoryCapabilities {
    ...
    public static final ItemCapability<IDarkSteelCapability, Void> DARK_STEEL_CAPABILITY = ItemCapability
            .createVoid(EnderIOAPI.loc("dark_steel_capability"), IDarkSteelCapability.class);
