...
import static com.enderio.legacy_layout.armory.common.capability.DarkSteelCapability.DarkSteelItemUpgrades.ITEM_UPGRADES_CODEC;

import com.enderio.legacy_layout.armory.common.capability.DarkSteelCapability;
...
public class ArmoryDataComponents {
    ...
    private static final DeferredRegister<DataComponentType<?>> DATA_COMPONENT_TYPES = DeferredRegister
            .create(Registries.DATA_COMPONENT_TYPE, EnderIOAPI.NAMESPACE);
