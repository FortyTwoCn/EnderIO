...
import com.enderio.legacy_layout.armory.common.item.darksteel.upgrades.explosive.ExplosiveUpgrade;
...
public final class DarkSteelUpgradeRegistry {
    ...
    public static final String UPGRADE_PREFIX = EnderIOAPI.NAMESPACE + ".darksteel.upgrade.";
