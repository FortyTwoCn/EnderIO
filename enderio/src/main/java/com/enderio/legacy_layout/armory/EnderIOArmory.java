package com.enderio.legacy_layout.armory;
...
import com.enderio.legacy_layout.armory.common.item.darksteel.upgrades.flight.GliderIntegration;
import com.enderio.legacy_layout.armory.common.item.darksteel.upgrades.jump.JumpUpgrade;
...
import com.enderio.legacy_layout.armory.data.loot.ArmoryLootModifiersProvider;
import com.enderio.legacy_layout.armory.data.recipe.ItemRecipeProvider;
import com.enderio.legacy_layout.armory.data.tags.ArmoryBlockTagsProvider;
...
public class EnderIOArmory {
    ...
    public static final Regilite REGILITE = new Regilite(EnderIOAPI.NAMESPACE);
