package com.enderio.legacy_layout.base.common.lang;
...
public class EIOEnumLang {
    ...
    private static <T extends Enum<T>> EnumTranslationMap.Builder<T> builder(Class<T> enumClass, String prefix) {
        return new EnumTranslationMap.Builder<>(EnderIOAPI.NAMESPACE, EIOEnumLang::addTranslation, enumClass, prefix);
    }
