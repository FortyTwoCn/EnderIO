...
import com.enderio.legacy_layout.base.api.filter.FilterMenuProvider;
...
public class EIOCapabilities {
    ...
    public static final class SideConfig {
        public static final BlockCapability<com.enderio.legacy_layout.base.api.capability.SideConfig, Direction> BLOCK = BlockCapability
                .createSided(EnderIOAPI.loc("side_config"), com.enderio.legacy_layout.base.api.capability.SideConfig.class);
    }
