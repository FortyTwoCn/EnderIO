...
public class EngineSoul {
    ...
    public record SoulData(ResourceLocation entitytype, String fluid, int powerpermb, int tickpermb) implements com.enderio.legacy_layout.machines.common.souldata.SoulData {
        @Override
