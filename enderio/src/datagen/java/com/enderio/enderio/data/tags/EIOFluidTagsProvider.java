...
public class EIOFluidTagsProvider extends FluidTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        tag(EnderIOTags.Fluids.COLD_FIRE_IGNITER_FUEL).add(EIOFluids.VAPOR_OF_LEVITY.getSource());
        tag(EnderIOTags.Fluids.STAFF_OF_LEVITY_FUEL).add(EIOFluids.VAPOR_OF_LEVITY.getSource());
    }
}
